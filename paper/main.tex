...
La combinaci\'on RF + Watershed~3D Density alcanza el mejor F1 de instancia (0.209 en test), estableciendo una l\'inea base robusta y eficiente. La brecha entre calidad sem\'antica y calidad de instancia sugiere que las mejoras m\'as impactantes en ITS vendr\'an de segmentadores capaces de separar copas adyacentes en canopias densas mediante priors sobre geometr\'ia de copa, segmentadores end-to-end, o mejores estrategias de seeding. Estos resultados no implican que Watershed~3D represente el l\'imite superior del desempe\~no posible, sino que evidencian c\'omo la continuidad geom\'etrica de las copas puede limitar la separaci\'on de instancias incluso cuando la clasificaci\'on sem\'antica es altamente precisa. Trabajo futuro incluye comparaci\'on con TreeLearn~\cite{henrich2024} y SegmentAnyTree~\cite{wielgosz2024}, extensi\'on a FOR-instanceV2~\cite{xiang2025}, y estrategias de seeding adaptativas que combinen CHM y densidad seg\'un la variabilidad local de altura. Más que proponer un nuevo método competitivo estado-del-arte, este trabajo aporta una disección experimental interpretable del pipeline ITS, permitiendo observar explícitamente cómo la calidad semántica y la separación geométrica de instancias interactúan bajo condiciones ULS densas. El c\'odigo fuente y los scripts de reproducci\'on est\'an disponibles en \url{https://github.com/Cantuuuu/ITS-Pipeline-Comparison}.
