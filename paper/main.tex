...
El conjunto de test comprende 11~plots y 323~\'arboles GT, lo que introduce varianza en estimaciones por sitio (especialmente CULS con 20~\'arboles y TUWIEN con 35). PointNet++ se eval\'ua con una \'unica configuraci\'on de hiperpar\'ametros; una b\'usqueda exhaustiva podr\'ia mejorar su rendimiento. Las conclusiones experimentales directas sobre el cuello de botella son espec\'ificas al Watershed~3D volum\'etrico evaluado. Sin embargo, los patrones de error observados ---especialmente la fusi\'on de copas adyacentes en canopias continuas--- sugieren una dificultad geom\'etrica m\'as amplia para la separaci\'on de instancias en ULS denso. Segmentadores recientes como TreeLearn~\cite{henrich2024} o SegmentAnyTree~\cite{wielgosz2024} podr\'ian mejorar el desempe\~no absoluto, pero su comparaci\'on directa queda como trabajo futuro. Los resultados son espec\'ificos a datos ULS ($454$--$10\,156$~pts/m$^2$); la transferencia a ALS convencional no est\'a garantizada. Por lo tanto, las conclusiones presentadas deben interpretarse específicamente dentro del contexto de nubes ULS densas y no como una caracterización universal del comportamiento de pipelines ITS sobre todas las modalidades LiDAR.
