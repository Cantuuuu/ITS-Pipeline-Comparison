...
\bottomrule
\multicolumn{6}{l}{\footnotesize $^\dagger$SD $>$ media en algunos flujos refleja distribuciones de F1 fuertemente asim\'etricas con acumulaci\'on en cero (plots donde el segmentador falla completamente); v\'ease mediana en resultados complementarios.}
\end{tabular}
\end{table}
