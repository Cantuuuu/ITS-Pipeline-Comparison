...
Trabajo futuro incluye comparación con TreeLearn~\cite{henrich2024} y SegmentAnyTree~\cite{wielgosz2024}, extensión a FOR-instanceV2~\cite{xiang2025}, y estrategias de seeding adaptativas que combinen CHM y densidad seg\'un la variabilidad local de altura, as\'i como un an\'alisis detallado de la naturaleza del error (sobre- vs.\ infra-segmentaci\'on) por tipo de bosque y su relaci\'on con la geometr\'ia de copa.
%% ================================================================
%%  REFERENCIAS
%% ================================================================
