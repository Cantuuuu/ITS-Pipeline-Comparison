...
Trabajo futuro incluye comparación con TreeLearn~\cite{henrich2024} y SegmentAnyTree~\cite{wielgosz2024}, extensión a FOR-instanceV2~\cite{xiang2025}, y estrategias de seeding adaptativas que combinen CHM y densidad según la variabilidad local de altura. El c\'odigo fuente y los scripts de reproducci\'on est\'an disponibles en \url{https://github.com/Cantuuuu/ITS-Pipeline-Comparison}.
