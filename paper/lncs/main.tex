...
La nube completa (excluyendo clases $\{0, 3\}$) se pasa directamente al segmentador. Todos los flujos comparten el c\'alculo de la altura sobre el suelo (height above ground, HAG) a partir de un modelo digital de terreno (digital terrain model, DTM) interpolado sobre puntos de suelo, truncada a $[0, 50]$\,m.
